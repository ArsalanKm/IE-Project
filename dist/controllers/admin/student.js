...
router.post('/student', jwt_1.authMiddleware, (req, res) => (0, utils_1.createUtil)('student', req, res));
...
router.delete('/student/:id', jwt_1.authMiddleware, (req, res) => (0, utils_1.deleteItemUtil)('student', req, res));
